...
def _get_browser_paths():
    ...
    Retorna um dicionário com os caminhos encontrados.
    """
    ...
    def control_queue_monitor():
        ...
        try:
            ...
            if action == "load_filters":
                ...
                q_gui.put({"type": "info", "title": "Processo Interrompido", "message": "A auditoria foi parada sem salvar o relatório.", "done": True})
        except queue.Empty:
            pass
